...
class Translations extends ChangeNotifier {
  ...
  final Map<String, Map<String, String>> _localizedValues = {
    'de': {
      ...
      'pres1':'Druckeingabe 150 Bar - 650 bar',
      'pres2':'Druckeingabe 2176 PSI - 9427 PSI',
      'pres3':'Bitte geben Sie den Druck ein',
      'pres4':'Solldruck muss zwischen 150 und 650 bar liegen',
      ...
      'tools6':'Fehler: interpolierter Druckwert {value} bar außerhalb des Bereichs (150-650 bar)',
    ...
    'en': {
      ...
      'pres1': 'Pressure input 150 bar - 650 bar',
      'pres2': 'Pressure input 2176 PSI - 9427 PSI',
      'pres3': 'Please enter the pressure',
      'pres4': 'Target pressure must be between 150 and 650 bar',
      ...
      'tools6': 'Error: Interpolated pressure value {value} bar out of range (150-650 bar)',
      ...
      'pdf4':'Target torque [Nm]',
      'pdf5':'Actual torque [Nm]',
      'pdf6':'Date',
